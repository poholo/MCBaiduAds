...
#define FRAME1 CGRectMake(kScreenWidth, 0, kScreenWidth, kScreenWidth*0.5)
#define FRAME2 CGRectMake(kScreenWidth*2, 0, kScreenWidth, kScreenWidth*0.5)
...
- (void)timeToScroll {
    ...
    if (contentOffsetX == 2*kScreenWidth) {
        ...
        self.scrollView.contentOffset = CGPointMake(contentOffsetX+=kScreenWidth, 0);
    }
}
...
- (void)configScrollView {
    ...
    scrollView.frame = CGRectMake(0, 64, kScreenWidth, kScreenWidth*0.5);
    if(ISIPHONEX) {
        scrollView.frame = CGRectMake(0, 84, kScreenWidth, kScreenWidth*0.5);
    }
...
- (void)configPageControl {
    ...
    if(ISIPHONEX) {
        centerY = 84+self.scrollView.frame.size.height-20;
    }
